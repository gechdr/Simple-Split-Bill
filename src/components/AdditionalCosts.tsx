      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-3 py-2.5 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-900 dark:text-gray-100 rounded-lg transition border border-gray-300 dark:border-gray-600 text-sm font-medium whitespace-nowrap flex items-center justify-center smooth-interactive"
            >
        ...
        <div>
          ...
          <button
            ...
            className={`w-full px-4 py-2.5 rounded-lg border transition flex items-center justify-between smooth-interactive ${roundTo100 ? "bg-gray-900 dark:bg-gray-600 text-white border-gray-900 dark:border-gray-600" : "bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"}`}
