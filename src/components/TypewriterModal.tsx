      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-md w-full shadow-2xl animate-slide-down">
        ...
        {shareUrl && (
          <textarea
            ...
            className="w-full px-3 py-2.5 mb-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 text-sm font-mono resize-none focus:outline-none focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 cursor-text"
            rows={3}
          />
        )}
